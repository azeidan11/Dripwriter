      ...
      <section className="relative mx-auto w-full px-6 md:px-8 pt-10 pb-20 lg:pl-[255px]">
        ...
        <div className="px-6 lg:pl-8 lg:pr-4">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            {/* Email Settings */}
            <div className="rounded-lg shadow-2xl bg-white text-card-foreground shadow-sm">
              ...
              <div className="p-6 pt-0">
                ...
                <div className="flex gap-2">
                  <input
                    className="text-black flex h-10 w-full rounded-md border border-black bg-white px-3 py-2 text-sm"
                    id="email"
                    value={email}
                    readOnly
                  />
          ...
          {/* Help */}
          <div className="rounded-lg shadow-2xl bg-white text-card-foreground shadow-sm mt-6">
